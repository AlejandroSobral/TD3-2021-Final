...
;;;;;;;;;;;;;;;START - Paging;;;;;;;;;;;;;;;;;;;;;       
    ...
    mov     ebp, esp
    push SUP_W_P
    push dword(__INIT_32_VMA+0x1000) ; Rom init
    push dword(__INIT_32_VMA+0x1000)
    push dword(__CR3_KERNEL)          
    call set_dtp_pt_merged_rom
    leave
    ...
    mov     ebp, esp
    push SUP_W_P;Ok     
    push dword(__STACK_KERNEL_T1_PHY)
    push dword(__STACK_KERNEL_T1_VMA)
    push dword(__CR3_TASK1)  
    call set_dtp_pt_merged_rom
    leave       
    ;;
...
;------------------TASK 2-----------------
    ...
    mov     ebp, esp
    push SUP_W_P     
    push dword(__STACK_KERNEL_T2_PHY)
    push dword(__STACK_KERNEL_T2_VMA)
    push dword(__CR3_TASK2)  
    call set_dtp_pt_merged_rom
    leave  
    ;;
...
;------------------TASK 3-----------------
    ...
    mov     ebp, esp
    push SUP_W_P     
    push dword(__STACK_KERNEL_T3_PHY)
    push dword(__STACK_KERNEL_T3_VMA)
    push dword(__CR3_TASK3)  
    call set_dtp_pt_merged_rom
    leave
    ;;  
...
;------------------TASK 4-----------------
    ...
    mov     ebp, esp
    push SUP_W_P     
    push dword(__STACK_KERNEL_T4_PHY)
    push dword(__STACK_KERNEL_T4_VMA)
    push dword(__CR3_TASK4)  
    call set_dtp_pt_merged_rom
    leave
    ;;
